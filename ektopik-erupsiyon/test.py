...
def randomTest():
    ...
    # # visualize.display_instances(image, SAVE_DIR,r['rois'], r['masks'], r['class_ids'], 
...
#55 ektopik var mı yok mu 
#0,5 - 0,95

#confidence yüksek olanları işaretleyelim
# %20 -> val  
# %80 -> train                --->FOLD1
...
# bambaşka %20 çekilir ve model tekrar %80 ile eğitilp farklı bir 200 ile test edilir.         FOLD2

#farklı 200ler üzerinde test edilmiş 5 katlama elde edilir

# k fAULT cross validation
#10 tane 55 etiketli 65 bulduğu
#10 tane 65 etiketli 55 bulduğu
#10 tane 55 etiketli 55 bulduğu


#map performanslarını elde edelim
# #[14:47, 08.04.2024] doğukan: STEPS_PER_EPOCH = NUMBER_OF_SAMPLES/BATCH_SIZE
# According to the MaskRCNN code:
# BATCH_SIZE = IMAGES_PER_GPU*GPU_COUNT
# That means that:
# STEPS_PER_EPOCH = NUMBER_OF_SAMPLES/(IMAGES_PER_GPU*GPU_COUNT)
# [14:56, 08.04.2024] doğukan: sistem analizi -> dataseti tanımla örnek görüntü falan
